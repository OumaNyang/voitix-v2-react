      ...
      <nav id="navbar" className="navbar">
        <ul>
          ...
          <li><a href="./#pricing">Pricing</a></li>
           <li className="dropdown"><a href="#support"><span>Support</span> <i className="bi bi-chevron-down dropdown-indicator"></i></a>
            <ul>
          ...
          <li><a className="get-a-quote" href="https://voitix.azacloud.com/login">Sign In / Sign Up</a></li>
        </ul>
      </nav> 
